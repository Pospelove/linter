...
export class CodegenCheck extends BaseCheck {
    ...
    constructor(repoRoot, options = {}) {
        ...
        if (typeof command !== "string")
            throw new Error("CodegenCheck requires options.command to be a string");
        if (typeof inputFile !== "string")
            throw new Error("CodegenCheck requires options.inputFile to be a string");
        if (typeof outputFile !== "string")
            throw new Error("CodegenCheck requires options.outputFile to be a string");
    ...
    static getHelp() {
        return {
            name: "CodegenCheck",
            description: "Verifies generated output files are up-to-date. " +
                "Lint reads output into RAM, runs generator, compares, and rolls back. " +
                "Fix just runs the generator.",
            options: 'command — generator command to run; ' +
