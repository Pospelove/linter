 ...
 */
export const resolvePaths = (paths, file, resolveTemplate, repoRoot) => paths.map((p) => {
    const expanded = file
 ...
 */
export const dedupePaths = (paths) => Array.from(new Set(paths.map((p) => path.resolve(p))));
/**
 ...
 */
export const getStringHash = (str) => createHash("sha256").update(str).digest("hex");
/**
