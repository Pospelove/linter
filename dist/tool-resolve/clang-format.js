...
import { getToolPaths, ensureDirExists, checkInPath, downloadFile, extractArchive, } from "./tool-utils.js";
...
export async function getClangFormatPath({ shouldDownload, shouldSearchInPath, toolsDir }) {
    ...
    if (shouldSearchInPath) {
        ...
        if (systemPath) {
            ...
            console.log(`System clang-format is version ${systemVersion}, need ${requiredMajor}+. Will download ${VERSION}.`);
        }
        else {
